...
if(ACTION == '') {
	...
	echo "<div class='panel'>";
		echo "<div class='panel-header'>Slides  
...
//Image cropping
	...
	echo "<form action='' method='post' enctype='multipart/form-data'>";
		...
		echo "<div class='panel'>";
			...
			echo "<div class='panel-content clearfix'>";
				echo "<div class='form-field'>
					...
					<label>Content </label>
					<textarea name='content' class='textarea'>".(isset($row['content']) ? $row['content'] : '')."</textarea>
				</div>";
				echo "<div class='form-field'>
		...
		// Image
		echo "<div class='panel'>";
			echo "<div class='panel-header'>$record_name Image
				<span class='f_right'><a class='panel-toggle fa fa-chevron-up'></a></span>
			</div>";
			echo "<div class='panel-content clearfix'>";
